<?php
   ...
   ?>
    ...
    <head>
        <title>Manage Candidates | NIM</title>
    ...
    <body class="w3-yellow">
        <nav class="w3-sidebar w3-bar-block w3-small w3-center">
            ...
            <a class="w3-bar-item w3-button w3-padding-large w3-hover-black" href="admin_home.html">
        ...
        <div class="w3-padding-large" id="main">
            <header class="w3-container w3-padding-32 w3-center w3-yellow" id="home">
                <h1 class="w3-jumbo"><strong>Manage Nrm FlagBearers</strong></h1>
            </header>
            <table class="w3-table w3-border w3-responsive" style='font-family: sans-serif;'>
               ...
               $query = "SELECT *
                       FROM candidate1 ORDER BY member_id DESC";
               ...
               while($row = mysqli_fetch_assoc($ret)){
                   ...
                   echo '<div id="'. $id. '" class="w3-modal">
                       <div class="w3-modal-content w3-animate-right w3-card-4">
                         ...
                         <form method="POST" onsubmit="return check();">
                           ...
                           <button class="w3-button w3-yellow w3-section w3-padding" type="submit" name="update" ><strong>Update Account</strong></button>
                           </div>
                           </form>
                         </div>
                       </div>
                   ...
                   if($validity == '0000-00-00'){
                       ...
                       $valid = 'Nomination valid until '.$validity;
                   }
                          ...
                          <input type="hidden" value="'.$validity.'" name="validity" required>
                           <div class="w3-row w3-center w3-padding-16 w3-section w3-light-grey">
                             <div class="w3-half w3-section">
                               ...
                               '.$valid.'<br>
                               <button class="w3-button w3-yellow w3-section w3-padding" type="submit" name="enroll"><strong>Enroll / Extend</strong></button>
                               <h3>UGX200.00</h3>
                             </div>
                             <div class="w3-half w3-section">
                               <span class="w3-xlarge">'. $daysleft .'</span><br>
                               Days left until next payment<br>
                               <button class="w3-button w3-yellow w3-section w3-padding" type="submit" name="add"><strong>Add 30 Days</strong></button>
                               <h3>UGX800.00</h3>
                             </div>
                           </div>
                           </form>
            ...
            <footer class="w3-center" style='margin-top: 20px;'> Copyright © 2013-2020 The  Nrm. All rights reserved.</footer>
        </div>
