        ...
        <div class="w3-padding-large" id="main">
            ...
            <div class="w3-row w3-center w3-padding-16 w3-section w3-light-grey">
                <div class="w3-section w3-third">
                    ...
                    <br>Post District Declaration of Results.
                </div>
                <div class="w3-section w3-third">
                    ...
                    <br> Edit Registrars in your district.
                </div>
                    ...
                    <div class="w3-modal-content w3-animate-top" style="max-width:600px">
                        ...
                        <div class="w3-container" style="color:black">
                            ...
                            <div class="w3-bar w3-yellow">
                                <button class="w3-bar-item w3-button tablink w3-dark-grey" onclick="openCity(event,'Bulking')">Sub-County</button>
                                <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Cutting')">Parish</button>
